---
title: "Advanced R packaging"
subtitle: "Building FAIR R packages for scientists"
...
![](figs/Carpentries_R_packaging.png)
e.g., [carpentries](carpentries-incubator.github.io/lesson-R-packaging/) and [Utrecht University](github.com/UtrechtUniversity/tutorial-r-package/)
...
::: {.top-right}
![](figs/devtools_logo.png)
:::

![](figs/devtools_workflow.png)

## Spellchecking: `spelling`

:::{.top-right}
![](figs/spelling_logo.png)
:::
...
-   Wide range of tests available in other packages: Figures, server responses, "golden tests", etc.
...
-   Citation info in [`CITATION.cff`](https://citation-file-format.github.io/) 
or under `inst/CITATION`
-   Generation via `cffr`
-   Automatic transfer of metadata to 
...
![](figs/UU_OS_Infographic_2022.png)
...
![](figs/StratPal_R_help.png)

## StratPal publication

![](figs/StratPal_publication.png)
